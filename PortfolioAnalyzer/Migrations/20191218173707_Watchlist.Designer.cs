...
namespace PortfolioAnalyzer.Migrations
{
    ...
    [Migration("20191218173707_Watchlist")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortfolioAnalyzer.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "84072c3e-c847-44dc-a250-741bf5b1d454",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECX/euEY/NVKgeuQ9BYdKuLfZlEK99gPzFxHoy/KCxh8+JUQh2kd1Ehi+2u9mgpeHw==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5f17f8b9-c6dc-4cea-9c7f-6d8d0bfda8d3",
                            Email = "joe@gmail.com",
                            EmailConfirmed = true,
                            FirstName = "Joe",
                            LastName = "Snyder",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGCFgCaX54mMYLBYJMzSZYlwX1A4sRgIloC87hOKzC/MFEuXa3tUygNRgTjxLSsCdA==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("PortfolioAnalyzer.Models.Watchlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PortfolioAnalyzer.Models.WatchlistSecurity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PortfolioAnalyzer.Models.WatchlistSecurity", b =>
                {
                    b.HasOne("PortfolioAnalyzer.Models.Security", "Security")
                        .WithMany("WatchlistSecurities")
                        .HasForeignKey("SecurityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PortfolioAnalyzer.Models.Watchlist", "Watchlist")
                        .WithMany("WatchlistSecurities")
